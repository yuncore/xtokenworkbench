        ...
        <div style="width: 300px; float: right">
          <div class="stat-card">
            ...
            <div class="content">
              <div class="top-btns">
                ...
                <span v-for="(item, index) in statType" :key="index" v-if="item.show" :class='{active: statTypeActiveIndex == index}' @click="statTypeBtnClick(item.type, index)">
                  {{item.label}}
                </span>
              </div>
              <div ref="statChart" style="height: 200px">
              </div>
              <div class="divider">
                <div class="line"></div>
                <div class="dot"></div>
          ...
          <div class="time-select-card">
            ...
            <div class="time-field">
              ...
              <i class="el-icon-edit-outline" v-show="!startTimePickerShow" v-if="voteState.type == 0" @click="changeTime('start')"></i>
              <el-date-picker ref="startTimePicker" v-model="timeSelect" v-show="startTimePickerShow" type="datetime" placeholder="选择日期时间" align="right" size="mini" @blur="onStartTimePickerBlur" style="width: 200px">
              </el-date-picker>
              <div style="float: right">
                <span class="btn" v-if="voteState.type == 0" @click="startVote">
                  立即开始
                </span>
              </div>
            </div>
            <div class="time-field">
              ...
              <i class="el-icon-edit-outline" v-show="!endTimePickerShow" v-if="voteState.type == 0 || voteState.type == 1" @click="changeTime('end')"></i>
              <el-date-picker ref="endTimePicker" v-model="timeSelect" v-show="endTimePickerShow" type="datetime" placeholder="选择日期时间" align="right" size="mini" @blur="onEndTimePickerBlur" style="width: 200px">
              </el-date-picker>
              <div style="float: right">
                <span class="btn" v-if="voteState.type == 1" @click="stopVote">
                  立即结束
                </span>
              </div>
            </div>
        ...
        <div style="margin-right: 320px">
          <div class="event-card">
            <div class="head">
              ...
              <h3>
                <span>{{eventType[eventInfo.type]}})</span>{{eventInfo.title}}</h3>
            </div>
          ...
          <div class="relation-currency-card">
            <div class="head">
              <p>关联项目</p>
            </div>
