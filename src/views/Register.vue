            ...
            <div class="page page-front">
                <div class="page-content">
                    <div class="input-row" style="text-align: center">
                        <img src="static/img/guan2.svg" class="fadeIn delay1"/>
                    </div>
                    <div class="input-row">
                        <label class="label fadeIn">手机号</label>
                        <input v-model.trim="phone" type="text" class="input delay1 fadeIn">
                    </div>
                    <div class="input-row password">
                        <label class="label fadeIn delay2">姓名</label>
                        <input v-model.trim="name" class="input delay2 fadeIn ">
                    </div>
                    <div class="input-row password">
                        <label class="label fadeIn delay2">邀请码</label>
                        <input v-model.trim="code" class="input delay2 fadeIn ">
                    </div>
                    <div class="input-row password">
                        <label class="label fadeIn delay3">密码</label>
                        <input v-model.trim="password" type="password" class="input fadeIn delay3">
                    </div>
                    <div class="input-row password" style="margin-bottom: 30px">
                        <label class="label fadeIn delay4 ">重复密码</label>
                        <input v-model.trim="checkPassword" type="password" class="input  fadeIn delay4">
                    </div>
                    <div class="input-row perspective">
                        <button @click="register" class="button load-btn"
                                :class="[{loading: loading}, 'button', 'load-btn', 'fadeIn', 'delay4']">
                            <span class="default"><i class="ion-arrow-right-b"></i>创建账号</span>
...
.rotateplane-enter-active {
  animation: rotateplane 0.5s;
}

.rotateplane-leave-active {
  animation: rotateplane 0.5s reverse;
}
...
#window .button.load-btn .default,
