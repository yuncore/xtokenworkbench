    ...
    <div>
        ...
        <div id="content">
            ...
            <div class="card toggle-card chart"
                 ...
                 v-loading="commentStatLoading"
                 element-loading-text="数据加载中"
                 element-loading-spinner="el-icon-loading"
                 element-loading-background="rgba(0, 0, 0, 0.8)">
                <div class="content">
                    <div ref="keywordChart" style="width: 1200px; height: 600px; margin: 0 auto">
                    </div>
                </div>
            </div>
            ...
            getComments (params, keyword) {
                ...
                let succ = res => {
                    ...
                    this.comments = res.map((item, index) => {
                        item.content = item.content.replace(re, `<strong>${keyword}</strong>`)
                        return item
                    })
                }
                let fail = res => {
